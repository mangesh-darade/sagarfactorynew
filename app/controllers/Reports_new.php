...
//            ob_clean();
    ...
    public function request_gst_report($type = NULL, $year = NULL, $month = NULL, $xls = NULL, $warehouse = NULL, $biller = NULL, $supplier = NULL, $sale_items = FALSE, $customer = NULL) {
        ...
        if ($type == "sale_gst_report") {
            ...
            $data = $this->reports_model_new->getSaleGstData($year, $month, $warehouse, $biller, $sale_items, $customer );
...
//                    $this->excel->getActiveSheet()->SetCellValue('AE' . $tax_row, $item['total_weight']);
 //                     $this->excel->getActiveSheet()->SetCellValue('AI' . $tax_row, $item['payment_method']);
            
                }//end foreach
                $row++;
                $this->excel->getActiveSheet()->getStyle("A" . $row . ":AI" . $row)->getBorders()->getTop()->setBorderStyle(PHPExcel_Style_Border::BORDER_MEDIUM);
            }
