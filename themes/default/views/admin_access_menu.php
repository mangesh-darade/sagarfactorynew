        ...
        <li id="products_quantity_adjustments">
            <a class="submenu"
               href="<?= site_url('products/quantity_adjustments'); ?>">
                ...
                <span class="text"> <?= lang('List Productions'); ?></span>
            </a>
        </li>
...
<li class="mm_reports mm_reports_new">
    ...
    <ul>
        ...
        <li id="reports_index">
            <a class="submenu" href="<?= site_url('reports/transferReport') ?>">
                <i class="fa fa-bars"></i><span
                   class="text"><?= lang('Transfer_Report'); ?><img src="<?= $assets ?>images/new.gif" height="30px" alt="new" /></span>
            </a>
        </li>
        ...
        <li id="reports_get_customer_wise_sales">
         ...
         <li id="reports_get_product_wise_sales">
            <a href="<?= site_url('reports/Product_wise_Sale_Report') ?>">
                <i class="fa fa-thumbs-up"></i><span
                    class="text"> <?= lang('Product_Wise_Sale_Report'); ?></span> <img src="<?= $assets ?>images/new.gif" height="30px"
                    alt="new" />
            </a>
        </li>
        <?php if (POS) { ?>
        ...
        <li id="reports_adjustments">
            <a href="<?= site_url('reports/adjustments') ?>">
                <i class="fa fa-filter"></i><span
                    class="text"> <?= lang('Adjustments & Production_report'); ?></span>
            </a>
        </li>
